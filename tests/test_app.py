...
#         assert filetype_combo.currentText() == filetype
#
...
#         )
#
# def test_extract_error_handling(qtbot_app, mock_subprocess_run, tmp_path):
#     qtbot, window = qtbot_app
#     extract_btn = window.findChild(QPushButton, "extract_btn")
#     select_file_btn = window.findChild(QPushButton, "select_file_btn")
#     file_path_label = window.findChild(QLabel, "file_path_label")
...
#         returncode=1, cmd='cmd', stderr='Extraction failed due to some error.'
#     )
#
...
#             window,
#             "Extraction Error",
#             "Extraction failed due to some error."
#         )
#
